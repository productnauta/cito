...
- Fazer claim atômico do documento mais antigo na collection "case_query" com status="new"
...
- Atualizar status do case_query: new -> extracting -> extracted (ou error)

IMPORTANTE (alterações solicitadas):
- Collection de entrada: case_query (não raw_html)
- Campo do HTML original: htmlRaw (direto no documento)
